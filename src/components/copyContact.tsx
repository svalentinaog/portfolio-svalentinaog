...
const ContactMe: React.FC = () => {
  ...
  const validateForm = (formData: { user_name: string; user_email: string; user_message: string }) => {
    ...
    // Validaciones para el campo de mensaje
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (validateForm(formData)) {
      // Continuar con el envío del formulario si la validación es exitosa :D
      try {
      ...
      // Detener el envío del formulario si hay errores de validación D:
      setLoading(false);
    }
  };
